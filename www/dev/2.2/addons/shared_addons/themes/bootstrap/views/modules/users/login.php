...
<ul class="list-unstyled">
	...
	<li class="form_buttons">
		<input type="submit" value="Entrar" name="btnLogin" class="btn btn-primary" /> <span class="register"> | <?php echo anchor('faq/como-entrar-en-harwin', lang('user:register_btn'));?></span>
	</li>
	<li class="reset_pass">
